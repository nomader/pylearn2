...
class VVEth(DenseDesignMatrix):
    ...
    def __init__(self, which_set,
        ...
        files = {'train': 'eth_train.csv', 'public_test' : 'eth_test.csv'}
        ...
        super(VVEth, self).__init__(X=X, y=y, view_converter=view_converter)
    ...
    def _load_data(self, path, expect_labels):
        ...
        if expect_labels:
            ...
            one_hot = np.zeros((y.shape[0],5),dtype='float32')
