...
class VVEmox24(DenseDesignMatrix):
    """
    A Pylearn2 Dataset class for accessing the data for the
    facial expression recognition Kaggle contest for the ICML
    2013 workshop on representation learning.
    ...
    def __init__(self, which_set,
        ...
        files = {'train': 'emo_x24_train.csv', 'public_test' : 'emo_x24_test.csv'}
        ...
        view_converter = DefaultViewConverter(shape=[24,24,1], axes=axes)

        super(VVEmox24, self).__init__(X=X, y=y, view_converter=view_converter)
    ...
    def get_test_set(self):
        return VVEmox24(**self.test_args)
