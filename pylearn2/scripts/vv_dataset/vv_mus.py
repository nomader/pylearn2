...
class VVMus(DenseDesignMatrix):
    ...
    def __init__(self, which_set,
        ...
        files = {'train': 'mus_train.csv', 'public_test' : 'mus_test.csv'}
        ...
        super(VVMus, self).__init__(X=X, y=y, view_converter=view_converter)
