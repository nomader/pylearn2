...
class VVEmo(DenseDesignMatrix):
    ...
    def __init__(self, which_set,
        ...
        files = {'train': 'emo_train.csv', 'public_test' : 'emo_test.csv'}
        ...
        super(VVEmo, self).__init__(X=X, y=y, view_converter=view_converter)
