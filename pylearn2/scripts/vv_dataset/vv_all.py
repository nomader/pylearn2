...
class VVAll(DenseDesignMatrix):
    ...
    def __init__(self, which_set,
        ...
        files = {'train': 'all_train.csv', 'public_test' : 'all_test.csv'}
        ...
        super(VVAll, self).__init__(X=X, y=y, view_converter=view_converter)
