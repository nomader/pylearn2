...
class VVAge(DenseDesignMatrix):
    ...
    def __init__(self, which_set,
        ...
        files = {'train': 'age_train.csv', 'public_test' : 'age_test.csv'}
        ...
        super(VVAge, self).__init__(X=X, y=y, view_converter=view_converter)
