...
class VVPalm(DenseDesignMatrix):
    """
    A Pylearn2 Dataset class for accessing the data for the
    facial expression recognition Kaggle contest for the ICML
    2013 workshop on representation learning.
    ...
    def __init__(self, which_set,
        ...
        files = {'train': 'palm_train.csv', 'public_test' : 'palm_test.csv'}
        ...
        view_converter = DefaultViewConverter(shape=[64,64,1], axes=axes)

        super(VVPalm, self).__init__(X=X, y=y, view_converter=view_converter)
