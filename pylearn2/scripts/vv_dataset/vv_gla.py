...
class VVGla(DenseDesignMatrix):
    ...
    def __init__(self, which_set,
        ...
        files = {'train': 'gla_train.csv', 'public_test' : 'gla_test.csv'}
        ...
        super(VVGla, self).__init__(X=X, y=y, view_converter=view_converter)
