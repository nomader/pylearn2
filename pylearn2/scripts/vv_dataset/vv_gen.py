...
class VVGen(DenseDesignMatrix):
    ...
    def __init__(self, which_set,
        ...
        files = {'train': 'gen_train.csv', 'public_test' : 'gen_test.csv'}
        ...
        super(VVGen, self).__init__(X=X, y=y, view_converter=view_converter)
