...
class VVA2e(DenseDesignMatrix):
    ...
    def __init__(self, which_set,
        ...
        files = {'train': 'a2e_train.csv', 'public_test' : 'a2e_test.csv'}
        ...
        view_converter = DefaultViewConverter(shape=[91,1,1], axes=axes)

        super(VVA2e, self).__init__(X=X, y=y, view_converter=view_converter)
