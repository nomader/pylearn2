...
class VVAu(DenseDesignMatrix):
    ...
    def __init__(self, which_set,
        ...
        files = {'train': 'au_train.csv', 'public_test' : 'au_test.csv'}
        ...
        super(VVAu, self).__init__(X=X, y=y, view_converter=view_converter)
