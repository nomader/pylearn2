...
class VVEmox36(DenseDesignMatrix):
    """
    A Pylearn2 Dataset class for accessing the data for the
    facial expression recognition Kaggle contest for the ICML
    2013 workshop on representation learning.
    ...
    def __init__(self, which_set,
        ...
        files = {'train': 'emo_x36_train.csv', 'public_test' : 'emo_x36_test.csv'}
        ...
        view_converter = DefaultViewConverter(shape=[36,36,1], axes=axes)

        super(VVEmox36, self).__init__(X=X, y=y, view_converter=view_converter)
    ...
    def get_test_set(self):
        return VVEmox36(**self.test_args)
