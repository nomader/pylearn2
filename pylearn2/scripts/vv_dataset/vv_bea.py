...
class VVBea(DenseDesignMatrix):
    ...
    def __init__(self, which_set,
        ...
        files = {'train': 'bea_train.csv', 'public_test' : 'bea_test.csv'}
        ...
        super(VVBea, self).__init__(X=X, y=y, view_converter=view_converter)
