...
class VVEmox72(DenseDesignMatrix):
    """
    A Pylearn2 Dataset class for accessing the data for the
    facial expression recognition Kaggle contest for the ICML
    2013 workshop on representation learning.
    ...
    def __init__(self, which_set,
        ...
        files = {'train': 'emo_x72_train.csv', 'public_test' : 'emo_x72_test.csv'}
        ...
        view_converter = DefaultViewConverter(shape=[72,72,1], axes=axes)

        super(VVEmox72, self).__init__(X=X, y=y, view_converter=view_converter)
    ...
    def get_test_set(self):
        return VVEmox72(**self.test_args)
