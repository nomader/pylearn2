...
class VVAam(DenseDesignMatrix):
    ...
    def __init__(self, which_set,
        ...
        files = {'train': 'aam_train.csv', 'public_test' : 'aam_test.csv'}
        ...
        super(VVAam, self).__init__(X=X, y=y, view_converter=view_converter)
